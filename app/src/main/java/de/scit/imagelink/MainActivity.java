...
public class MainActivity extends AppCompatActivity {
    ...
    private void getImages() {
        ...
        int resolution = metrics.widthPixels / IMAGES_NUMBER_PORTRAIT;

        ImageRestApi.getImages("", resolution, new JsonHttpResponseHandler() {
            @Override
    ...
    private void fillTable() {
        TableLayout table = findViewById(R.id.img_table);
        TableRow newRow = new TableRow(this);
        newRow.setLayoutParams(new TableLayout.LayoutParams(0, TableLayout.LayoutParams.MATCH_PARENT));
        ...
        TableRow.LayoutParams layout = new TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT, TableRow.LayoutParams.WRAP_CONTENT, (float)1.0);
        img1.setLayoutParams(layout);
        img2.setLayoutParams(layout);
        img3.setLayoutParams(layout);
